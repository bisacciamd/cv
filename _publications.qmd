...
pubs <- ifelse(is.null(pubs), 24, pubs)
```

::: {.content-visible when-profile="english"}
I have contributed to various scientific books, notably including Braunwald’s Heart Disease, the ESC Textbook of Cardiovascular Medicine, and the EACVI Textbook of Cardiovascular Magnetic Resonance. I have also authored `r pubs` Scopus-indexed  publications, where I contributed to literature review, statistical analyses, manuscript drafting, and/or preparation of tables, visual illustrations, and figures. My publications may also be accessed on [PubMed](https://pubmed.ncbi.nlm.nih.gov/?term=%22Bisaccia%20Giandomenico%22%5BAuthor%5D).

## Chapters in books
**"Artificial intelligence in cardiovascular imaging"** (chapter author). *The ESC Textbook of Cardiovascular Medicine* (fourth edition). Edited by Nico Bruining et al, OUP, 2026.

**"Myocardial Infarction with Nonobstructed Coronary Arteries"** (chapter author). *EACVI Textbook of Cardiovascular Magnetic Resonance*. Edited by Sven Plein, Chiara Bucciarelli-Ducci and Steffen Petersen, OUP, 2026.

**"Cardiovascular Magnetic Resonance"** book chapter (listed contributor). *Braunwald’s Heart Disease*, edited by Robert O. Bonow, Douglas L. Mann, Gordon F. Tomaselli, Deepak L. Bhatt, Scott D. Solomon, Peter Libby, Eugene Braunwald, Elsevier, 2026.

**"Acute Coronary Syndromes".** *Magnetic Resonance Imaging Atlas* (chapter author), Cardiology *(«RISONANZA MAGNETICA - TESTO ATLANTE»*), edited by Patrizia Pedrotti and Francesco Secchi, Poletto, 2025.
...
## Capitoli di libri
**"Artificial intelligence in cardiovascular imaging"** (autore). *ESC Textbook of Cardiovascular Medicine* (quarta edizione). Edito da Nico Bruining et al, OUP, 2026.

**"Myocardial Infarction with Nonobstructed Coronary Arteries"** (autore). *EACVI Textbook of Cardiovascular Magnetic Resonance*. Edito da Sven Plein, Chiara Bucciarelli-Ducci e Steffen Petersen, OUP, 2026.

**"Cardiovascular Magnetic Resonance"** (contributor), *Braunwald’s Heart Disease*, edito da Robert O. Bonow, Douglas L. Mann, Gordon F. Tomaselli, Deepak L. Bhatt, Scott D. Solomon, Peter Libby, Eugene Braunwald, Elsevier, 2026.

**"Sindromi coronariche acute".** (autore). *RISONANZA MAGNETICA - TESTO ATLANTE* (collana diretta da Angelo Vanzulli) Cardiologia (a cura di Patrizia Pedrotti, Francesco Secchi), Poletto Editore, 2025.

## Studi originali
:::

**Diagnostic and prognostic comparison of stress ECG, CMR and SPECT, alone and sequentially, in stable chest pain** (2025). **G. Bisaccia**, P. P. Swoboda, J. F. Younger, N. Maredia, C. J. Dickinson, J. M. Brown, C. Bucciarelli-Ducci, S. Plein and J. P. Greenwood.
...
**[Artificial intelligence-enhanced ECG interpretation: a new era for electrocardiography?]** (2025).
F. Ricci, M. L. Rizzuto, **G. Bisaccia**, D. Mansour, S. Gallina, L. Sciarra, G. Bagliani, A. Dello Russo, A. Mortara and G. Ciliberti.
*G Ital Cardiol (Rome)*.
[{{< bi box-arrow-up-right >}}](https://doi.org/10.1714/4542.45427)
...
*Echocardiography*.
[{{< bi box-arrow-up-right >}}](https://doi.org/10.1111/echo.15859)
...
::: {.content-visible when-profile="english"}
## Editorials, Case reports, and Letters to the editor
:::
::: {.content-visible when-profile="italian"}
## Editoriali, Case report e Lettere agli editori
:::
**A Changing Climate Requires Changing Tools: Environmental Exposures and Cardiovascular Health through a CMR Imaging Lens** (2026).
**G. Bisaccia** and K. Hanneman.
*European Heart Journal - Cardiovascular Imaging*.
[{{< bi box-arrow-up-right >}}](https://doi.org/10.1093/ehjci/jeag109)

**Stress CMR and Chronic Total Occlusions: Will the Fermi Function Solve the Fermi Paradox?** (2025).
**G. Bisaccia** and F. Ricci.
*European Heart Journal - Cardiovascular Imaging*.
[{{< bi box-arrow-up-right >}}](https://doi.org/10.1093/ehjci/jeaf286)

**Cardiac allograft vasculopathy and splenic switch-off: «off we go»?** (2025).
**G. Bisaccia**, J. Wong and C. Bucciarelli-Ducci.
*Journal of Cardiology*.
[{{< bi box-arrow-up-right >}}](https://doi.org/10.1016/j.jjcc.2025.05.009)
